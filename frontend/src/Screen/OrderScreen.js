            ...
            <Col md={8}>
                <ListGroup variant='flush'>
                    <ListGroup.Item>
                        ...
                        {order.isDeliverd ? (<Message variant='success'>Paid on {order.DeliveredAt}</Message>) : (<Message variant='danger'>Not Delivered</Message>)}
                    </ListGroup.Item>
                    <ListGroup.Item>
                        <h2>
                            Payment Method
                        ...
                        <ListGroup.Item>
                            <h2>Order Item</h2>
                            {order.orderItems.length === 0 ? (<Message>Your cart is EmptyS</Message>) :
                                (<ListGroup variant='flush'>
